...
/**
* Use this to test functions and other php stuff
* access at: roadtrippossible.com/test
*
*/
function rtp_test() {
...
// namespace Adcuz\FatSecret;
   ...
   $key = '5c7cfda61ce445738dee3d025237b604';
  $secret = 'fbec10194fd246b3882f6769194dd78b';
$data = new Client($key, $secret);
  $query = '1 cup sugar';
  $info = $data->SearchFood($query, $region = false, $language = false, $maxResults = false);
  d($info); 
